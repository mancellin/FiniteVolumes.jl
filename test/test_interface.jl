...
@testset "Interface with other packages" begin
    @testset "Measurements" begin
        ...
        dt = 0.01
        w = w0 .- dt*FiniteVolumes.div(flux, mesh, w0, Upwind())
    end
    ...
    @testset "Unitful" begin
        ...
        w2 = w1 .- dt*FiniteVolumes.div(flux, mesh, w1, Upwind())
    ...
    @testset "ForwardDiff" begin
        ...
        function run(v)
            ...
            dt = 0.01
            w2 = w .- dt*FiniteVolumes.div(f, mesh, w, Upwind())
        end
    ...
    @testset "OrdinaryDiffEq" begin
        ...
        dwdt_upwind(w, p, t) = -FiniteVolumes.div(flux, mesh, w, Upwind())
