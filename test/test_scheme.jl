...
@test local_upwind_flux(from_left_2f_2d, SVector(1.0, 1.0), [], SVector(0.0, 0.0), []) == (SVector(1.0, 1.0), 1.0)
@test local_upwind_flux(from_right_2f_2d, SVector(1.0, 1.0), [], SVector(0.0, 0.0), []) == (SVector(0.0, 0.0), 1.0)
